...
void edit_colourBlock(int objectNumber, unsigned char colour)
{
	...
	{
	case BLACK:
		block[objectNumber].properties.colour[RED] = black[RED];
	...
	unsigned char green, unsigned char blue, unsigned char alpha)
{
	...
	{
	case POLYGON:
		polygon[objectNumber].properties.colour[RED] = red;
		...
		break;
	case BLOCK:
		block[objectNumber].properties.colour[RED] = red;
...
void edit_colourPolygon(int objectNumber, unsigned char colour)
{
	...
	{
	case BLACK:
		polygon[objectNumber].properties.colour[RED] = black[RED];
...
void edit_resize(unsigned char object, int objectNumber, double scale)
{
	...
	{
	case POLYGON:
		polygon[objectNumber].radius = polygon[objectNumber].radius * scale;
